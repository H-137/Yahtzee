...
//create rolling thing for the dice

//create an array of die objects to contain the dice and state of their ability to be rolled

//create a checker to see which of the scores is highest
...
//THE MOST SAVER BOT FOR OF A KIND / YATZEE
function mostSaver(){
  var count = 0;
  var max = 0;
  var maxVal = 1;
